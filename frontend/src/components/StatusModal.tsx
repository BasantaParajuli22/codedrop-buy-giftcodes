...
interface StatusModalProps {
  ...
  // NEW PROP: To indicate if the order contained gift cards
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* NEW: Conditional message for gift card orders */}
        {isSuccess && isGiftCardOrder && (
          <p className="mt-3 text-sm font-semibold text-indigo-700">
            Your gift code(s) have been sent to your registered email address. Please check your inbox (and spam folder)!
