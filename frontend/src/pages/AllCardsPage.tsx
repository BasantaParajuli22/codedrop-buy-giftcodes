...
const AllCardsPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-center text-gray-900 mb-2">Our Gift Cards</h1>
      <p className="text-center text-gray-600 mb-10">The perfect gift for any occasion.</p>
